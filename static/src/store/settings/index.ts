...
import { SettingsData, SystemOperationParams, RootState, DisplayPowerSchedule } from '@/types'
    ...
    try {
      ...
      const defaultSchedule = {
        ...
        days: {
          ...
          '5': { on: '08:00', off: '22:00' }, '6': null as { on: string; off: string } | null,
          '7': null as { on: string; off: string } | null,
        },
      }
      const dps = data.display_power_schedule
      return {
        ...
        displayPowerSchedule: dps && typeof dps === 'object'
          ? { enabled: !!dps.enabled, days: dps.days || defaultSchedule.days }
          : defaultSchedule,
    ...
    try {
      const response = await fetch('/api/v2/device_settings', {
        ...
        body: JSON.stringify({
          ...
          display_power_schedule: settings.displayPowerSchedule,
