  ...
  return (
    ...
    >
      <div className="row mb-3 uri">
        <label className="col-4 col-form-label">{t('addAsset.assetUrl')}</label>
        <div className="col-7 controls">
          <input
            ...
            placeholder={t('addAsset.urlPlaceholder')}
            type="text"
      ...
      <div className="row mb-3 skip_asset_check_checkbox">
        <label className="col-4 small">{t('addAsset.skipAssetCheck')}</label>
